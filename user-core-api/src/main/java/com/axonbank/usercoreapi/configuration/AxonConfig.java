package com.axonbank.usercoreapi.configuration;
...
public class AxonConfig {
    ...
    @Bean
    public EmbeddedEventStore eventStore(EventStorageEngine storageEngine, AxonConfiguration axonConfig) {
        return EmbeddedEventStore.builder()
                .storageEngine(storageEngine)
                .messageMonitor(axonConfig.messageMonitor(EventStore.class, "eventStore"))
                .build();
    }
